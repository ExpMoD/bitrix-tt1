...
INSERT INTO `b_agent` VALUES (1,'main',100,'CEvent::CleanUpAgent();','Y','2017-10-27 17:22:57','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(2,'main',100,'CUser::CleanUpHitAuthAgent();','Y','2017-10-27 17:22:57','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(3,'main',100,'CCaptchaAgent::DeleteOldCaptcha(3600);','Y','2017-10-27 20:25:02','2017-10-27 21:25:02',NULL,3600,'N',NULL,'N'),(4,'main',100,'CUndo::CleanUpOld();','Y','2017-10-27 17:22:57','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(5,'main',100,'CSiteCheckerTest::CommonTest();','Y',NULL,'2017-10-28 03:00:00',NULL,86400,'N',NULL,'N'),(6,'main',100,'\\Bitrix\\Main\\Analytics\\CounterDataTable::submitData();','Y','2017-10-27 20:30:23','2017-10-27 20:31:23',NULL,60,'N',NULL,'N'),(7,'forum',100,'CForumStat::CleanUp();','Y','2017-10-27 17:22:57','2017-10-28 17:22:57',NULL,86400,'N',NULL,'N'),(8,'forum',100,'CForumFiles::CleanUp();','Y','2017-10-27 17:22:57','2017-10-28 17:22:57',NULL,86400,'N',NULL,'N'),(9,'search',10,'CSearchSuggest::CleanUpAgent();','Y','2017-10-27 17:22:57','2017-10-28 17:22:57',NULL,86400,'N',NULL,'N'),(10,'search',10,'CSearchStatistic::CleanUpAgent();','Y','2017-10-27 17:22:57','2017-10-28 17:22:57',NULL,86400,'N',NULL,'N'),(11,'security',100,'CSecuritySession::CleanUpAgent();','Y','2017-10-27 20:13:51','2017-10-27 20:43:51',NULL,1800,'N',NULL,'N'),(12,'security',100,'CSecurityIPRule::CleanUpAgent();','Y','2017-10-27 20:25:02','2017-10-27 21:25:02',NULL,3600,'N',NULL,'N'),(13,'seo',100,'Bitrix\\Seo\\Engine\\YandexDirect::updateAgent();','Y','2017-10-27 20:25:02','2017-10-27 21:25:02',NULL,3600,'N',NULL,'N'),(14,'seo',100,'Bitrix\\Seo\\Adv\\LogTable::clean();','Y','2017-10-27 17:22:57','2017-10-28 17:22:57',NULL,86400,'N',NULL,'N'),(15,'seo',100,'Bitrix\\Seo\\Adv\\Auto::checkQuantityAgent();','Y','2017-10-27 20:25:02','2017-10-27 21:25:02',NULL,3600,'N',NULL,'N'),(16,'subscribe',100,'CSubscription::CleanUp();','Y',NULL,'2017-10-28 03:00:00',NULL,86400,'Y',NULL,'N'),(34,'main',100,'CEventLog::CleanUpAgent();','Y','2017-10-27 20:27:34','2017-10-28 20:27:34',NULL,86400,'N',NULL,'N');
...
INSERT INTO `b_iblock_messages` VALUES (1,'ELEMENT_NAME','Новость'),(1,'ELEMENTS_NAME','Новости'),(1,'ELEMENT_ADD','Добавить новость'),(1,'ELEMENT_EDIT','Изменить новость'),(1,'ELEMENT_DELETE','Удалить новость'),(1,'SECTION_NAME','Раздел'),(1,'SECTIONS_NAME','Разделы'),(1,'SECTION_ADD','Добавить раздел'),(1,'SECTION_EDIT','Изменить раздел'),(1,'SECTION_DELETE','Удалить раздел'),(2,'ELEMENT_NAME','Элемент'),(2,'ELEMENTS_NAME','Товары'),(2,'ELEMENT_ADD','Добавить товар'),(2,'ELEMENT_EDIT','Изменить товар'),(2,'ELEMENT_DELETE','Удалить товар'),(2,'SECTION_NAME','Раздел'),(2,'SECTIONS_NAME','Разделы'),(2,'SECTION_ADD','Добавить раздел'),(2,'SECTION_EDIT','Изменить раздел'),(2,'SECTION_DELETE','Удалить раздел'),(3,'ELEMENT_NAME','Услуга'),(3,'ELEMENTS_NAME','Услуги'),(3,'ELEMENT_ADD','Добавить услугу'),(3,'ELEMENT_EDIT','Изменить услугу'),(3,'ELEMENT_DELETE','Удалить услугу'),(3,'SECTION_NAME','Раздел'),(3,'SECTIONS_NAME','Разделы'),(3,'SECTION_ADD','Добавить раздел'),(3,'SECTION_EDIT','Изменить раздел'),(3,'SECTION_DELETE','Удалить раздел'),(4,'ELEMENT_NAME','Вакансия'),(4,'ELEMENTS_NAME','Вакансии'),(4,'ELEMENT_ADD','Добавить вакансию'),(4,'ELEMENT_EDIT','Изменить вакансию'),(4,'ELEMENT_DELETE','Удалить вакансию'),(4,'SECTION_NAME','Раздел'),(4,'SECTIONS_NAME','Разделы'),(4,'SECTION_ADD','Добавить раздел'),(4,'SECTION_EDIT','Изменить раздел'),(4,'SECTION_DELETE','Удалить раздел'),(5,'SECTION_DELETE','Удалить раздел'),(5,'SECTIONS_NAME','Разделы'),(5,'SECTION_ADD','Добавить раздел'),(5,'SECTION_EDIT','Изменить раздел'),(5,'ELEMENT_ADD','Добавить элемент'),(5,'ELEMENT_EDIT','Изменить элемент'),(5,'SECTION_NAME','Раздел'),(5,'ELEMENT_DELETE','Удалить элемент'),(5,'ELEMENTS_NAME','Элементы'),(5,'ELEMENT_NAME','Элемент');
...
INSERT INTO `b_iblock_property` VALUES (1,'2017-10-27 14:23:09',2,'Специальное предложение','Y',100,'SPECIALOFFER',NULL,'L',1,30,'C','N','5',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(2,'2017-10-27 14:23:09',2,'Цена','Y',200,'PRICE',NULL,'N',1,30,'L','N','6',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(3,'2017-10-27 14:23:09',2,'Валюта цены (подпись)','Y',300,'PRICECURRENCY',NULL,'L',1,30,'C','N','7',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(4,'2017-10-27 14:23:09',2,'Габариты (Д х Ш х В)','Y',400,'SIZE',NULL,'S',1,30,'L','N','8',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(5,'2017-10-27 14:23:09',2,'Размеры спального места','Y',500,'S_SIZE',NULL,'S',1,30,'L','N','9',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(6,'2017-10-27 14:23:09',2,'Артикул','Y',600,'ARTNUMBER',NULL,'S',1,30,'L','N','10',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(7,'2017-10-27 14:23:09',2,'Материал','Y',700,'MATERIAL',NULL,'S',1,30,'L','N','11',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(8,'2017-10-27 14:23:09',2,'Производитель','Y',800,'MANUFACTURER',NULL,'S',1,30,'L','N','12',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(9,'2017-10-27 17:14:03',5,'Должность','Y',500,'POSITION','','S',1,30,'L','N','9','',5,NULL,0,'N','Y','Y','N',1,NULL,NULL,''),(10,'2017-10-27 17:14:04',5,'Компания','Y',500,'COMPANY','','S',1,30,'L','N','10','',5,NULL,0,'N','Y','N','N',1,NULL,NULL,''),(11,'2017-10-27 17:08:22',5,'Документы','Y',500,'DOCS','','F',1,30,'L','Y',NULL,'pdf',5,NULL,0,'N','N','N','N',1,NULL,NULL,'');
...
INSERT INTO `b_search_phrase` VALUES (1,'2017-10-27 20:14:26','s1',1,1,'f749370da7144694c02595f01ced0dfc','.net-девелопмент',NULL,'http://bitrix-tt1/rew/dmitriya-pyalov/','N','s1',NULL,NULL);
...
INSERT INTO `b_user` VALUES (1,NULL,'admin','9qbNWLnR4315cf535af21af36bfac13292435cb0','hRWQNOIS531390ddf51d33f6920d12fb77d2de37','Y','Андрей','Кудаков','kudakovandrey@gmail.com','2017-10-27 20:30:37','2017-10-27 17:22:53',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2017-10-27 17:22:53',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2017-10-27 20:30:50
